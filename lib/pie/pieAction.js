...
export const GLOBAL_LOAD_ENV = '@@PIE/GLOBAL_LOAD_ENV';
export const GLOBAL_INIT_PIE_CONNECT = '@@PIE/GLOBAL_INIT_PIE_CONNECT';
export const GLOBAL_ENTER_PAGE = '@@PIE/GLOBAL_ENTER_PAGE';
